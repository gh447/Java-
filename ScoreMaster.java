        ...
        while (cont) {
            ...
            switch (oprtId) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    int bestOfAllYearsScore = 0;
                    year = 0;
                    for (int i = 0; i < scores.length; i++) {
                        for (int j = 0; j < scores[i].length; j++) {
                            if (scores[year][bestOfAllYearsScore] < scores[i][j]) {
                                year = i;
                                bestOfAllYearsScore = j;
                            }
                        }
                    }
                    System.out.println("历年最好成绩为第" + (year + 1) + "年的" + names[bestOfAllYearsScore] + "成绩：" + scores[year][bestOfAllYearsScore]);
                    break;
                case 4:
                    System.out.println("请问要查询那门课历年最好成绩：");
